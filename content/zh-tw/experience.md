...
positions:
  - company: "瑞軒科技股份有限公司"
    ...
    bullet_points:
      ...
      - "以 YOLO OBB 搭配 OpenCV 完成 HDMI 插線的孔位／姿態辨識與視覺對位；以 AprilTag 搭配 OpenCV 完成 HDMI／電源線拔線的接頭定位；整合腕部六軸力／扭矩感測與接觸搜尋，並以受限範圍內的螺旋微動完成最後插接定位。已於真機驗證；整體線材插接流程在 10 次測試中由 70% 基準達到 90% 成功率。"
