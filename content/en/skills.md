...
type: "homepage"
intro: >-
  End-to-end engineering across robot control, robotics software, Embodied AI, VLA / robot learning, perception, force-guided insertion recovery, and systems integration.
domains:
  - icon: "robot"
  ...
  - icon: "magnifying-glass"
    ...
    description: "Developed a PatchCore anomaly-detection API server and PyQt prototype with ROI extraction, resize/crop/normalize/clip preprocessing, template replacement, and anomaly-score evaluation; it is not yet integrated into a formal inspection or production flow."
