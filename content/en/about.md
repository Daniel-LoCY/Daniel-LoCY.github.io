...
type: "homepage"
intro: >-
  I am Daniel Lo, an AI Robotics Engineer at AMTRAN TECHNOLOGY CO., LTD., focused on robot control, Embodied AI, VLA / robot learning, visual servoing, force-guided contact search and insertion alignment, PatchCore anomaly detection, and Digital Twin data workflows. I also build frontend/backend platforms with React, TypeScript, Next.js, FastAPI, WebSocket, PyQt, and Docker, connecting robot control, data workflows, policy inference, and simulation / real-world validation.
study: >-
