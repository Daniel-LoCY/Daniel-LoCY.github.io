...
PDF 履歷採一頁式標準求職格式，保留職涯定位、核心成果、工作經歷、核心技能、學歷與榮譽；完整專案細節、Demo、截圖與驗證資料則保留在個人網站。
版面使用較大的內文字級與較寬鬆的行距，優先維持紙本閱讀性，同時保持中英文 PDF 都是一頁 A4。
工作經歷以四項重點呈現，並將 3～4 倍資料蒐集量與 70% → 90% 線材插接成功率獨立拉出，方便招聘者快速掃讀。
...
建置與測試固定在 Docker container 中執行，會檢查兩份 PDF 是否為單頁、必要欄位與核心成果是否存在，以及長篇驗證摘要與完整專案細節是否已移出 PDF。
